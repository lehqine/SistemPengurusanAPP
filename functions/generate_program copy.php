...
<table style="border: 1px solid black; width: 100%;">
   ...
   <tr><td style="width: 33%; border: 1px solid black;">Link Fail-fail Program: </td><td style="width: 66%; border: 1px solid black;"><a href="'.$programinfo[0][2].'">'.$programinfo[0][2].'</a></td></tr>

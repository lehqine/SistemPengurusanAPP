...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="column-6">
            <input type="text" class="input-text" name="gelaran" id="gelaran" value="<?php if (isset($user[0][11]))
            echo $user[0][11];
        else
            echo ""; ?>">
    </div>
    ...
    <div class="column-6">
        <input type="text" class="input-text" name="nama" id="nama" value="<?php if (isset($user[0][2]))
            echo $user[0][2];
        else
            echo ""; ?>">
    </div>
...
<div class="row">
    ...
    <div class="column-4">
        <input type="text" class="input-text" value="<?php if (isset($user[0][3]))
            echo $user[0][3];
        else
...
<div class="row">
    ...
    <div class="column-10">
        <select name="universiti" id="universiti">
            <?php if (isset($user[0][16]))
                echo "<option selected>" . $user[0][16] . "</option>";
...
<div class="row">
    ...
    <div class="column-4">
        <input type="text" class="input-text" value="<?php if (isset($user[0][12]))
            echo $user[0][12];
        else
    ...
    <div class="column-4">
        <input type="text" class="input-text" value="<?php if (isset($user[0][13]))
            echo $user[0][13];
        else
...
<div class="row">
    ...
    <div class="column-4">
        <select name="negeri" id="negeri">
            <?php if (isset($user[0][14]))
                echo "<option selected>" . $user[0][14] . "</option>";
...
<div class="row">
    ...
    <div class="column-5">
        <select name="bidang" id="bidang">
            <?php if (isset($user[0][10]))
                echo "<option selected>" . $user[0][10] . "</option>";
            include('../components/bidang_options.php');
            ?>
        </select>
    </div>
...
<div class="row">
    ...
    <div class="column-4">
        <input type="text" class="input-text" value="<?php if (isset($user[0][15]))
            echo $user[0][15];
        else
...
<div class="row">
    ...
    <div class="column-10">
        <input type="text" style="display: none;" value="<?php if (isset($user[0][17]))
            echo $user[0][17];
        else
...
<div class="row">
    ...
    <div class="column-10">
        <input type="text" style="display: none;" value="<?php if (isset($user[0][19]))
            echo $user[0][19];
        else
...
<div class="row">
    ...
    <div class="column-10">
        <input type="text" style="display: none;" value="<?php if (isset($user[0][18]))
            echo $user[0][18];
        else

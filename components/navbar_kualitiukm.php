...
$id = $_SESSION["id"];
       ...
       $query = "select * from kualitiukm_noti where KUALITIUKM_ID = '$id'  AND READ_NOTI='F'";
   ...
   <div class="logo" style="display: flex;align-items: center;cursor: pointer;">
            ...
            <div class="icons">
            <a href="../pages/noti_kualitiukm.php"><div id="noti-btn" class="fas fa-bell"><?php echo $number_of_result;?></div></a>

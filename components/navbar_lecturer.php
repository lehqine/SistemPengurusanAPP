...
$id = $_SESSION["id"];
       ...
       $query = "select * from lecturer_noti where LECTURER_ID = '$id'  AND READ_NOTI='F'";
   ...
   <div class="logo" style="display: flex;align-items: center;cursor: pointer;">
      ...
      <div class="icons">
      <a href="../pages/noti_lecturer.php"><div id="noti-btn" class="fas fa-bell"><?php echo $number_of_result;?></div></a>

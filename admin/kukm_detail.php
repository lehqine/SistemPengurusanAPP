...
if ($stmt = $con->prepare("SELECT `KUALITIUKM_ID`, `NAMA`, `PASSWORD`, `EMEL`, `NO_KP`, `ALAMAT`, `NO_TELEFON`, `URL_AVATAR` FROM kualitiukm WHERE KUALITIUKM_ID = '$aid' ")) {
  $stmt->execute();
...
<body>
  ...
  <div class="main-body">
      <?php
      include("./form_profil_kualitiukm2.php");
      ?>
